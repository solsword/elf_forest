// Copied from Processing example code & turned into a library
...
public class Perlin extends PApplet {
  public static int B = 0x100;
  public static int BM = 0xff;
  public static int N = 0x1000;
  public static int NP = 12;
  public static int NM = 0xfff;
  ...
  public float at3(float q[], float rx, float ry, float rz) {
    return (float) (rx * q[0] + ry * q[1] + rz * q[2]);
  }

  public Perlin(PApplet parent) {
    this.parent = parent;

    this.p = new int[B + B + 2];
    this.g3 = new float[B + B + 2][3];
    this.g2 = new float[B + B + 2][2];
    this.g1 = new float[B + B + 2];
