...
//  BIF_SEED
  ...
  _bdef( B_VINE_SEEDS, "vine_seeds",
    BI_VIS_TRANSPARENT,  BI_SBST_EMPTY,       BI_GEOM_GRASS,  SPT_VINE,
    BIF_GROWS | BIF_GROWTH_SITE | BIF_SEED);
  ...
  _bdef( B_HERB_SEEDS, "herb_seeds",
    BI_VIS_TRANSPARENT,  BI_SBST_EMPTY,       BI_GEOM_GRASS,  SPT_HERB,
    BIF_GROWS | BIF_GROWTH_SITE | BIF_SEED);
  ...
  _bdef( B_BUSH_SEEDS, "bush_seeds",
    BI_VIS_TRANSPARENT,  BI_SBST_EMPTY,       BI_GEOM_GRASS,  SPT_BUSH,
    BIF_GROWS | BIF_GROWTH_SITE | BIF_SEED);
  ...
  _bdef( B_SHRUB_SEEDS, "shrub_seeds",
    BI_VIS_TRANSPARENT,  BI_SBST_EMPTY,       BI_GEOM_GRASS,  SPT_SHRUB,
    BIF_GROWS | BIF_GROWTH_SITE | BIF_SEED);
  ...
  _bdef( B_TREE_SEEDS, "tree_seeds",
    BI_VIS_TRANSPARENT,  BI_SBST_EMPTY,       BI_GEOM_GRASS,  SPT_TREE,
    BIF_GROWS | BIF_GROWTH_SITE | BIF_SEED);
  ...
  _bdef( B_AQUATIC_PLANT_SEEDS, "aquatic_plant_seeds",
    BI_VIS_TRANSPARENT,  BI_SBST_EMPTY,       BI_GEOM_GRASS,  SPT_AQUATIC_PLANT,
