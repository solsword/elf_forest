...
ELFSCRIPT_GL(i, GEO_IGNEOUS)
ELFSCRIPT_GL(i, GEO_METAMORPHIC)
ELFSCRIPT_GL(i, GEO_SEDIMENTARY)
...
ELFSCRIPT_GL(i, MNRL_COMP_STONE)
ELFSCRIPT_GL(i, MNRL_COMP_LIFE)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_AIR)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_WATER)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_LIFE)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_STONE)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_STONE_LIFE)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_STONE_STONE)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_METAL)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_STONE_METAL)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_METAL_METAL)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_METAL_RARE)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_RARE)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_STONE_RARE)
ELFSCRIPT_GL(i, MNRL_COMP_STONE_RARE_RARE)
ELFSCRIPT_GL(i, MNRL_COMP_RARE_RARE)
...
ELFSCRIPT_GL(i, MNRL_TRACE_NONE)
ELFSCRIPT_GL(i, MNRL_TRACE_AIR)
ELFSCRIPT_GL(i, MNRL_TRACE_WATER)
ELFSCRIPT_GL(i, MNRL_TRACE_LIFE)
ELFSCRIPT_GL(i, MNRL_TRACE_STONE)
ELFSCRIPT_GL(i, MNRL_TRACE_STONE_METAL)
ELFSCRIPT_GL(i, MNRL_TRACE_METAL)
ELFSCRIPT_GL(i, MNRL_TRACE_METAL_METAL)
ELFSCRIPT_GL(i, MNRL_TRACE_METAL_RARE)
ELFSCRIPT_GL(i, MNRL_TRACE_RARE)
ELFSCRIPT_GL(i, MNRL_TRACE_RARE_RARE)
