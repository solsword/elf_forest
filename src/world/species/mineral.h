...
EFD_GL(i, GEO_IGNEOUS)
EFD_GL(i, GEO_METAMORPHIC)
EFD_GL(i, GEO_SEDIMENTARY)
...
EFD_GL(i, MNRL_COMP_STONE)
EFD_GL(i, MNRL_COMP_LIFE)
EFD_GL(i, MNRL_COMP_STONE_AIR)
EFD_GL(i, MNRL_COMP_STONE_WATER)
EFD_GL(i, MNRL_COMP_STONE_LIFE)
EFD_GL(i, MNRL_COMP_STONE_STONE)
EFD_GL(i, MNRL_COMP_STONE_STONE_LIFE)
EFD_GL(i, MNRL_COMP_STONE_STONE_STONE)
EFD_GL(i, MNRL_COMP_STONE_METAL)
EFD_GL(i, MNRL_COMP_STONE_STONE_METAL)
EFD_GL(i, MNRL_COMP_STONE_METAL_METAL)
EFD_GL(i, MNRL_COMP_STONE_METAL_RARE)
EFD_GL(i, MNRL_COMP_STONE_RARE)
EFD_GL(i, MNRL_COMP_STONE_STONE_RARE)
EFD_GL(i, MNRL_COMP_STONE_RARE_RARE)
EFD_GL(i, MNRL_COMP_RARE_RARE)
...
EFD_GL(i, MNRL_TRACE_NONE)
EFD_GL(i, MNRL_TRACE_AIR)
EFD_GL(i, MNRL_TRACE_WATER)
EFD_GL(i, MNRL_TRACE_LIFE)
EFD_GL(i, MNRL_TRACE_STONE)
EFD_GL(i, MNRL_TRACE_STONE_METAL)
EFD_GL(i, MNRL_TRACE_METAL)
EFD_GL(i, MNRL_TRACE_METAL_METAL)
EFD_GL(i, MNRL_TRACE_METAL_RARE)
EFD_GL(i, MNRL_TRACE_RARE)
EFD_GL(i, MNRL_TRACE_RARE_RARE)
