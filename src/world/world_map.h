...
FEED_SNEK(i, WM_HS_LAND)
FEED_SNEK(i, WM_HS_OCEAN)
FEED_SNEK(i, WM_HS_LAKE)
FEED_SNEK(i, WM_HS_OCEAN_SHOREE)
FEED_SNEK(i, WM_HS_LAKE_SHOREE)
FEED_SNEK(i, WM_HS_RIVER)
...
FEED_SNEK(i, WM_SL_FRESH)
FEED_SNEK(i, WM_SL_BRACKISH)
FEED_SNEK(i, WM_SL_SALINE)
FEED_SNEK(i, WM_SL_BRINY)
...
FEED_SNEK(i, WM_AC_OCEAN_DEPTHS)
FEED_SNEK(i, WM_AC_CONT_SHELF)
FEED_SNEK(i, WM_AC_COASTAL_PLAINS)
FEED_SNEK(i, WM_AC_INLAND_HILLS)
FEED_SNEK(i, WM_AC_HIGHLANDS)
FEED_SNEK(i, WM_AC_MOUNTAIN_SLOPES)
FEED_SNEK(i, WM_AC_MOUNTAIN_PEAKS)
...
FEED_SNEK(i, WM_PC_DESERT)
FEED_SNEK(i, WM_PC_ARID)
FEED_SNEK(i, WM_PC_DRY)
FEED_SNEK(i, WM_PC_NORMAL)
FEED_SNEK(i, WM_PC_SEASONAL)
FEED_SNEK(i, WM_PC_WET)
FEED_SNEK(i, WM_PC_SOAKING)
FEED_SNEK(i, WM_PC_FLOODED)
...
FEED_SNEK(i, WM_TC_ARCTIC)
FEED_SNEK(i, WM_TC_TUNDRA)
FEED_SNEK(i, WM_TC_COLD_FROST)
FEED_SNEK(i, WM_TC_COLD_RARE_FROST)
FEED_SNEK(i, WM_TC_MILD_FROST)
FEED_SNEK(i, WM_TC_MILD_RARE_FROST)
FEED_SNEK(i, WM_TC_WARM_FROST)
FEED_SNEK(i, WM_TC_WARM_NO_FROST)
FEED_SNEK(i, WM_TC_HOT)
FEED_SNEK(i, WM_TC_TROPICAL)
...
FEED_SNEK(i, WM_BC_UNKNOWN)
FEED_SNEK(i, WM_BC_DEEP_AQUATIC)
FEED_SNEK(i, WM_BC_OCEAN_VENTS)
FEED_SNEK(i, WM_BC_SEA_ICE)
FEED_SNEK(i, WM_BC_TEMPERATE_PELAGIC)
FEED_SNEK(i, WM_BC_TROPICAL_PELAGIC)
FEED_SNEK(i, WM_BC_TEMPERATE_OFFSHORE)
FEED_SNEK(i, WM_BC_TROPICAL_OFFSHORE)
FEED_SNEK(i, WM_BC_TEMPERATE_AQUATIC_GRASSLAND)
FEED_SNEK(i, WM_BC_TROPICAL_AQUATIC_GRASSLAND)
FEED_SNEK(i, WM_BC_TEMPERATE_AQUATIC_FOREST)
FEED_SNEK(i, WM_BC_TROPICAL_AQUATIC_FOREST)
FEED_SNEK(i, WM_BC_COLD_REEF)
FEED_SNEK(i, WM_BC_WARM_REEF)
FEED_SNEK(i, WM_BC_FREEZING_SHORE)
FEED_SNEK(i, WM_BC_COLD_SHORE)
FEED_SNEK(i, WM_BC_WARM_SHORE)
FEED_SNEK(i, WM_BC_TROPICAL_SHORE)
FEED_SNEK(i, WM_BC_FREEZING_LAKE)
FEED_SNEK(i, WM_BC_COLD_LAKE)
FEED_SNEK(i, WM_BC_TEMPERATE_LAKE)
FEED_SNEK(i, WM_BC_WARM_LAKE)
FEED_SNEK(i, WM_BC_TROPICAL_LAKE)
FEED_SNEK(i, WM_BC_SALT_LAKE)
FEED_SNEK(i, WM_BC_FREEZING_RIVER)
FEED_SNEK(i, WM_BC_COLD_RIVER)
FEED_SNEK(i, WM_BC_TEMPERATE_RIVER)
FEED_SNEK(i, WM_BC_WARM_RIVER)
FEED_SNEK(i, WM_BC_TROPICAL_RIVER)
FEED_SNEK(i, WM_BC_FREEZING_ALPINE)
FEED_SNEK(i, WM_BC_COLD_ALPINE)
FEED_SNEK(i, WM_BC_TEMPERATE_WET_ALPINE)
FEED_SNEK(i, WM_BC_TEMPERATE_DRY_ALPINE)
FEED_SNEK(i, WM_BC_WARM_WET_ALPINE)
FEED_SNEK(i, WM_BC_WARM_DRY_ALPINE)
FEED_SNEK(i, WM_BC_TROPICAL_WET_ALPINE)
FEED_SNEK(i, WM_BC_TROPICAL_DRY_ALPINE)
FEED_SNEK(i, WM_BC_FREEZING_DESERT)
FEED_SNEK(i, WM_BC_COLD_DESERT)
FEED_SNEK(i, WM_BC_TEMPERATE_DESERT)
FEED_SNEK(i, WM_BC_WARM_DESERT)
FEED_SNEK(i, WM_BC_HOT_DESERT)
FEED_SNEK(i, WM_BC_COLD_GRASSLAND)
FEED_SNEK(i, WM_BC_TEMPERATE_GRASSLAND)
FEED_SNEK(i, WM_BC_WARM_GRASSLAND)
FEED_SNEK(i, WM_BC_TROPICAL_GRASSLAND)
FEED_SNEK(i, WM_BC_COLD_SHRUBLAND)
FEED_SNEK(i, WM_BC_TEMPERATE_SHRUBLAND)
FEED_SNEK(i, WM_BC_WARM_SHRUBLAND)
FEED_SNEK(i, WM_BC_TROPICAL_SHRUBLAND)
FEED_SNEK(i, WM_BC_TEMPERATE_SAVANA)
FEED_SNEK(i, WM_BC_WARM_SAVANA)
FEED_SNEK(i, WM_BC_TROPICAL_SAVANA)
FEED_SNEK(i, WM_BC_COLD_CONIFER_FOREST)
FEED_SNEK(i, WM_BC_TEMPERATE_CONIFER_FOREST)
FEED_SNEK(i, WM_BC_WARM_CONIFER_FOREST)
FEED_SNEK(i, WM_BC_TROPICAL_CONIFER_FOREST)
FEED_SNEK(i, WM_BC_TEMPERATE_BROADLEAF_FOREST)
FEED_SNEK(i, WM_BC_WARM_WET_BROADLEAF_FOREST)
FEED_SNEK(i, WM_BC_WARM_DRY_BROADLEAF_FOREST)
FEED_SNEK(i, WM_BC_TROPICAL_WET_BROADLEAF_FOREST)
FEED_SNEK(i, WM_BC_TROPICAL_DRY_BROADLEAF_FOREST)
FEED_SNEK(i, WM_BC_TUNDRA)
FEED_SNEK(i, WM_BC_COLD_FRESHWATER_WETLAND)
FEED_SNEK(i, WM_BC_COLD_SALTWATER_WETLAND)
FEED_SNEK(i, WM_BC_TEMPERATE_FRESHWATER_WETLAND)
FEED_SNEK(i, WM_BC_TEMPERATE_SALTWATER_WETLAND)
FEED_SNEK(i, WM_BC_WARM_FRESHWATER_WETLAND)
FEED_SNEK(i, WM_BC_WARM_FRESHWATER_FORESTED_WETLAND)
FEED_SNEK(i, WM_BC_WARM_SALTWATER_WETLAND)
FEED_SNEK(i, WM_BC_TROPICAL_FRESHWATER_WETLAND)
FEED_SNEK(i, WM_BC_TROPICAL_FRESHWATER_FORESTED_WETLAND)
FEED_SNEK(i, WM_BC_TROPICAL_SALTWATER_WETLAND)
FEED_SNEK(i, WM_BC_TROPICAL_SALTWATER_FORESTED_WETLAND)
...
FEED_SNEK(i, WORLD_WIDTH)
FEED_SNEK(i, WORLD_HEIGHT)
...
FEED_SNEK(i, WORLD_REGION_BITS)
FEED_SNEK(i, WORLD_REGION_SIZE)
FEED_SNEK(i, WORLD_REGION_BLOCKS)
...
FEED_SNEK(i, WORLD_REGION_ANCHOR_HEIGHT)
...
FEED_SNEK(n, MAX_REGION_ANCHOR_DISTANCE)
...
FEED_SNEK(n, WM_REGION_CONTENTION_NOISE_STRENGTH)
FEED_SNEK(n, WM_REGION_CONTENTION_NOISE_SCALE)
FEED_SNEK(n, WM_REGION_CONTENTION_POLAR_STRENGTH)
FEED_SNEK(n, WM_REGION_CONTENTION_POLAR_SCALE)

// How far away from region boundaries "inner" points should be in fractions of
// a world region.
#define INNER_GEOPT_MARGIN 0.05
FEED_SNEK(n, INNER_GEOPT_MARGIN)
...
FEED_SNEK(i, WM_MAX_BIOME_OVERLAP)
...
FEED_SNEK(i, WM_MAX_BIOME_MUSHROOMS)
FEED_SNEK(i, WM_MAX_BIOME_MOSSES)
FEED_SNEK(i, WM_MAX_BIOME_GRASSES)
FEED_SNEK(i, WM_MAX_BIOME_VINES)
FEED_SNEK(i, WM_MAX_BIOME_HERBS)
FEED_SNEK(i, WM_MAX_BIOME_BUSHES)
FEED_SNEK(i, WM_MAX_BIOME_SHRUBS)
FEED_SNEK(i, WM_MAX_BIOME_TREES)
