...
FEED_SNEK(i, MFN_LINEAR)
FEED_SNEK(i, MFN_QUADRATIC)
FEED_SNEK(i, MFN_CUBIC)
FEED_SNEK(i, MFN_SQRT)
FEED_SNEK(i, MFN_EXPONENTIAL)
FEED_SNEK(i, MFN_EX_EXPONENTIAL)
FEED_SNEK(i, MFN_SIGMOID)
FEED_SNEK(i, MFN_HILL)
FEED_SNEK(i, MFN_TERRACE)
FEED_SNEK(i, MFN_SPREAD_UP)
FEED_SNEK(i, MFN_SPREAD_DOWN)
