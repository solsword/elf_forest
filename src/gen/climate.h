...
// River parameters:
#define CL_HEADWATERS_FLOW_THRESHOLD 0.14

#define CL_RIVER_SEED_CPT_DIST 0.8

//#define CL_RIVER_SEP_BASE 280.0
...
#define CL_TEMP_LOW (-30.0) // TODO: Change this? (see below)

// TODO: account for buffering effect of oceans?

#define CL_TEMP_ANTARCTIC_YEAR_LOW (-65.0)
#define CL_TEMP_ANTARCTIC_YEAR_MEAN (-55.0)
#define CL_TEMP_ANTARCTIC_YEAR_HIGH (-30.0)

#define CL_TEMP_ARCTIC_YEAR_LOW (-30.0)
#define CL_TEMP_ARCTIC_YEAR_MEAN (-16.5)
#define CL_TEMP_ARCTIC_YEAR_HIGH 2.0

#define CL_TEMP_TUNDRA_YEAR_LOW (-35.0)
#define CL_TEMP_TUNDRA_YEAR_MEAN (-15.0)
#define CL_TEMP_TUNDRA_YEAR_HIGH 15.0

#define CL_TEMP_COLD_TEMPERATE_YEAR_LOW (-1.0)
#define CL_TEMP_COLD_TEMPERATE_YEAR_MEAN 9.0
#define CL_TEMP_COLD_TEMPERATE_YEAR_HIGH 18.0

#define CL_TEMP_MODERATE_TEMPERATE_YEAR_LOW 5.0
#define CL_TEMP_MODERATE_TEMPERATE_YEAR_MEAN 12.0
#define CL_TEMP_MODERATE_TEMPERATE_YEAR_HIGH 20.0

#define CL_TEMP_WARM_TEMPERATE_YEAR_LOW 7.0
#define CL_TEMP_WARM_TEMPERATE_YEAR_MEAN 16.0
#define CL_TEMP_WARM_TEMPERATE_YEAR_HIGH 27.0

#define CL_TEMP_MODERATE_COASTAL_YEAR_LOW 10.0
#define CL_TEMP_MODERATE_COASTAL_YEAR_MEAN 14.0
#define CL_TEMP_MODERATE_COASTAL_YEAR_HIGH 18.0

#define CL_TEMP_SUBTROPICAL_YEAR_LOW 20.0
#define CL_TEMP_SUBTROPICAL_YEAR_MEAN 24.0
#define CL_TEMP_SUBTROPICAL_YEAR_HIGH 28.0

#define CL_TEMP_TROPICAL_YEAR_LOW 27.0
#define CL_TEMP_TROPICAL_YEAR_MEAN 28.5
#define CL_TEMP_TROPICAL_YEAR_HIGH 30.0

#define CL_TEMP_COASTAL_DESERT_YEAR_LOW 12.0
#define CL_TEMP_COASTAL_DESERT_YEAR_MEAN 17.0
#define CL_TEMP_COASTAL_DESERT_YEAR_HIGH 22.0

#define CL_TEMP_INLAND_DESERT_YEAR_LOW 9.0
#define CL_TEMP_INLAND_DESERT_YEAR_MEAN 18.0
#define CL_TEMP_INLAND_DESERT_YEAR_HIGH 35.0

#define CL_TEMP_SEASON_LOW_REGULAR_FROST (-5.0)
#define CL_TEMP_SEASON_LOW_INTERMITTENT_FROST (-3.0)
#define CL_TEMP_SEASON_LOW_INFREQUENT_FROST (-1.0)
#define CL_TEMP_SEASON_LOW_NO_FROST 0.0
...
#define CL_MIN_AVG_PRECIPITATION 10
#define CL_MEAN_AVG_PRECIPITATION 1000
#define CL_MAX_AVG_PRECIPITATION 1800

#define CL_PRECIPITATION_DESERT 250
#define CL_PRECIPITATION_ARID 500
#define CL_PRECIPITATION_NORMAL 1000
#define CL_PRECIPITATION_LUSH 1500
#define CL_PRECIPITATION_SOAKED 2000
#define CL_PRECIPITATION_FLOODED 2500
