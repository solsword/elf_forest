...
#define CL_SECONDARY_RIVER_SEP_BASE 20
#define CL_SECONDARY_RIVER_SEP_VAR 5

#define CL_TERTIARY_RIVER_SEP_BASE 9
#define CL_TERTIARY_RIVER_SEP_VAR 3

#define CL_QUATERNARY_RIVER_SEP_BASE 5.1
#define CL_QUATERNARY_RIVER_SEP_VAR 1.4
