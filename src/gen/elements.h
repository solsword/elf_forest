...
#define MIN_SOLUBLE_CORROSION_RESISTANCE 0.0
#define MAX_SOLUBLE_CORROSION_RESISTANCE 0.125
#define MIN_SLIGHTLY_CORROSION_RESISTANCE 0.0
#define MAX_SLIGHTLY_CORROSION_RESISTANCE 0.5
#define MIN_INSOLUBLE_CORROSION_RESISTANCE 0.25
#define MAX_INSOLUBLE_CORROSION_RESISTANCE 1.0
